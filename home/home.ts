...
export class Home implements OnInit { 
  ...
  get formValido() {
    return this.nombreValido && this.telefonoValido && this.calleValida && this.coloniaValida && this.cpValido && this.fechaValida && this.horaValida;
  }
  ...
  enviarSolicitudReserva() {
    ...
    if (this.formValido) {
      ...
      // 🚩 Mandamos this.solicitud tal cual, sin juntar los datos
